...
# ===================================================================
#  cron schedule intelligence (describe + preview, on cronexpr)
# ===================================================================
_MONTHS = [
    "",
    "January",
...
def next_fires(
    ...
    until the following occurrence, so the fire instants are accumulated
    by stepping an aware "now" forward through each delay.
    """
