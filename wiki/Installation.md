...
| Requirement | Value |
| --- | --- |
| Python (pip/pipx) | `>= 3.10`; 3.10, 3.11, 3.12, 3.13, 3.14 and 3.15 are supported and tested (`requires-python = ">=3.10"`). For an older Python, use the standalone binary instead. |
