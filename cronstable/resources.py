...
try:
    ...
    # cronstable at all; the feature is off by default anyway.
...
# Overrides: web.nodeHistory.{interval,points} (cronstable.config).
...
def resolve_node_history_config(
    ...
    ``web.metrics`` resolves in cronstable.prometheus).
    """
