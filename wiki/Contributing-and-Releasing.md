...
- `cronstable-linux-{amd64,arm64,i686,armv7,ppc64le,s390x,riscv64}.deb` and the same seven as `.rpm`, built with nfpm from the binaries above (no emulation: nfpm never executes the payload)
